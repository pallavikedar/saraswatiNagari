...
import Map7 from "../../components/Map/Map6";
  ...
  return (
    <div className={styles.container}>
        ...
        <motion.div
                             ...
                             >
                               <iframe
                                 ...
                                 src="https://www.youtube.com/embed/6eZQ_jyinMs?si=mqJXfHP2pEkmlRBK?autoplay=1&mute=1&controls=0&modestbranding=0&rel=0"
                                 frameBorder="0"
                                 allow="autoplay;"
                                 // allowFullScreen
                               />
      ...
      >
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d840.9951728657273!2d79.06258418597663!3d21.224417740630297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDEzJzI4LjQiTiA3OcKwMDMnNDQuOCJF!5e1!3m2!1sen!2sin!4v1766133526483!5m2!1sen!2sin" style={{width:"100%",height:"clamp(280px, 50vw, 450px)",border:"none",borderRadius:"10px"}} ></iframe>
        </div>
      </motion.section>
