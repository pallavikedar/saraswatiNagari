...
const WHATSAPP_NUMBER = "919494942894";
...
const UpcomingProjects = () => {
  ...
  const locations = [
    "Chicholi", "Fetri", "Khadgaon", "Kamptee",
    "Nagpur", "Chhindwara", "Hingna", "Kalmeshwar",
  ];
      ...
      <div className={styles.grid}>
        {locations.map((loc, i) => (
          ...
          >
            ...
            <button className={styles.cta} onClick={() => handleWhatsApp(loc)}>
              Get Early Access →
            </button>
          </div>
        ))}
