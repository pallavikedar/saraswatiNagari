...
// // Inject preconnect links into document head
...
// // Optimized video URL with cache busting for CDN edge caching
// const VIDEO_URL = "https://firebasestorage.googleapis.com/v0/b/abhi-9bd8f.firebasestorage.app/o/saraswati%20nagri%208%20(1)%20(1)%20(1).mp4?alt=media&token=aa64d50d-bcef-4a0b-9d92-6a6585394242";

// // High priority poster image (loaded instantly)
// const HERO_POSTER = "../assets/Sarswati Nagari 11.jpg.jpeg";

// // Preload hero poster as high priority
// if (typeof window !== "undefined") {
...
// // Optimized LazyImg with priority loading and native lazy loading
// const LazyImg = ({ src, alt, className, placeholder, priority = false, width, height }) => {
...
//         width: "100%",
//         height: "100%",
//         backgroundColor: placeholder || "#1a1a2e",
//       }}
//     >
//       {inView && (
//         <img
...
// // Optimized video component with instant poster display
...
//     // Force video to start playing as soon as possible
//     const playVideo = () => {
//       if (video && !hasStarted) {
//         video.play().catch(e => {
...
//   // Optimized table data with high-quality image URLs
//   const tableData = [
...
//       {/* Premium Layouts Section - Optimized Images */}
...
//                         placeholder="#1a1a2e"
//                         priority={i < 4} // Priority for first 4 cards
//                       />
