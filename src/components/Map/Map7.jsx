...
// ─── Plot Data (40 plots as per your original) ───────────────────────────────
const plotData = [
  ...
  { id: 9, price: "₹3,000", type: "Standard Lot", status: "sold", size: "30×40 ft", plotArea: "1200 sq.ft", facing: "North" },
  ...
  { id: 38, price: "₹3,000", type: "Standard Lot", status: "sold", size: "30×40 ft", plotArea: "1200 sq.ft", facing: "East" },
...
const PROJECT_NAME = "Saraswati Nagari — Phase 8";
          ...
          <div className="pm-map-scroll" ref={scrollContainerRef}>
            <div className="pm-map-wrap">
              ...
              >
                <img
                  ref={imageRef}
                  src="https://firebasestorage.googleapis.com/v0/b/abhi-9bd8f.firebasestorage.app/o/saraswati%20nagri%208_2%20-%20Photo%20(1).jpg?alt=media&token=21298f0a-4e8e-41b1-9658-f109f0b32c1f"
                  alt="Plot Layout Map"
