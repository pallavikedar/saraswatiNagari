...
// ─── Plot Data (16 plots as per your original) ───────────────────────────────
const plotData = [
  ...
  { id: 3, price: "₹3,000", type: "Standard Lot", status: "available", size: "30×40 ft", plotArea: "1200 sq.ft", facing: "East" },
  ...
  { id: 13, price: "₹3,000", type: "Standard Lot", status: "available", size: "30×40 ft", plotArea: "1200 sq.ft", facing: "North" },
...
const PROJECT_NAME = "Saraswati Nagari — Phase 5";
          ...
          <div className="pm-map-scroll" ref={scrollContainerRef}>
            <div className="pm-map-wrap">
              ...
              >
                <img
                  ref={imageRef}
                  src={import.meta.env.VITE_MAP_IMAGE_URL3}
                  alt="Plot Layout Map"
