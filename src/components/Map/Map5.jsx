...
const data = [
  ...
  { id: 9,  price: "3000", type: "Standard Lot", status: "available" },
  ...
  { id: 38,  price: "3000", type: "Standard Lot", status: "available" },
  ...
  // { id: "Open Space" ,  price: "3000", type: "Open Space", status: "Open Space" },
  { id: 51,  price: "3000", type: "Corner Lot", status: "sold" },
  ...
  { id: 60,  price: "3000", type: "Standard Lot", status: "sold" },
          ...
          <div className="scrollContainer">
            <div className="mapWrapper">
              <div className="mapContainer">
                <img
                  ref={imageRef}
                  src="https://firebasestorage.googleapis.com/v0/b/abhi-9bd8f.firebasestorage.app/o/SARASWATI%20NAGRI%206%20(1).jpg?alt=media&token=a8afe780-bc9c-41c2-9514-021caf770f4e"
                  alt="Plot Layout Map"
                  className="image"
                />
                {/* {plots.map((plot) => {
