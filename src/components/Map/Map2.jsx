...
const data = [
  ...
  { id: 4,  price: "3000", type: "Standard Lot", status: "available" },
  { id: 5,  price: "3000", type: "Standard Lot", status: "available" },
  { id: 6,  price: "3000", type: "Standard Lot", status: "available" },
  { id: 7,  price: "3000", type: "Standard Lot", status: "available" },
  { id: 8,  price: "3000", type: "Standard Lot", status: "available" },
          ...
          <div className="scrollContainer">
            <div className="mapWrapper">
              <div className="mapContainer">
                <img
                  ref={imageRef}
                  src="https://firebasestorage.googleapis.com/v0/b/abhi-9bd8f.firebasestorage.app/o/SARASWATI%20NAGRI%203%20(1).jpg?alt=media&token=e4ca4d02-449e-4a9c-ae35-2e171fa54bbb"
                  alt="Plot Layout Map"
                  className="image"
                />
                {/* {plots.map((plot) => {
